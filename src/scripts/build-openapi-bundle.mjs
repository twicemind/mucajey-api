...
const basePath = path.join(__dirname, '..', 'openapi', 'base.yaml');
...
const pathsDir = resolveCliPath(cliPathsDir) || path.join(__dirname, '..', 'openapi', 'paths');
const distDir = resolveCliPath(cliDistDir) || path.join(__dirname, '..', 'openapi', 'dist');
